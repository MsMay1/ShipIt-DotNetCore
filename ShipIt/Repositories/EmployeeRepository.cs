...
namespace ShipIt.Repositories
{
    ...
    public class EmployeeRepository : RepositoryBase, IEmployeeRepository
    {
        ...
        {
            string sql = "SELECT em_id, name, w_id, role, ext FROM em WHERE em_id = @id";
        ...
        public EmployeeDataModel GetOperationsManager(int warehouseId)
        {
            ...
            string sql = "SELECT em_id, name, w_id, role, ext FROM em WHERE w_id = @w_id AND role = @role";
            var parameters = new []
            {
        ...
        {
            string sql = "INSERT INTO em (em_id, name, w_id, role, ext) VALUES(@em_id, @name, @w_id, @role, @ext)";
